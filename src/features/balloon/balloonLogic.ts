 ...
 */
import { ISLAND_SHORE_RADIUS, ISLAND_WALK_RADIUS } from '../island/world'
import { ACTOR_POS, REACTIONS, ageReactions } from '../npc/actors'
import type { Mood } from '../npc/actors'
import { groundHeight, OCCLUDERS } from '../island/terrainLogic'
...
const SPOTS: Omit<Call, 'y' | 'crowd'>[] = [
  {
    ...
    x: 11,
    z: -3,
    label: 'The benches by the fountain',
  },
  {
    id: 'board',
    want: 'confetti',
    x: 8,
    z: 15,
    label: 'The crowd at the games board',
  },
  {
    id: 'north-road',
    want: 'water',
  ...
  { id: 'academy', want: 'confetti', x: 0, z: -59, label: 'The Academy steps' },
  {
    ...
    x: 41,
    z: -21,
    label: 'Discipline Road, no shade on it',
  },
  {
    id: 'work',
    want: 'confetti',
    x: 62,
    z: -34,
    label: 'The Work District forecourt',
  },
  { id: 'camp', want: 'water', x: 60, z: 39, label: 'The camp parade ground' },
  {
    ...
    x: -62,
    z: 43,
    label: 'The garden at Kitsos House',
  },
  { id: 'school', want: 'water', x: -64, z: -22, label: 'The school yard' },
  {
    ...
    x: -38,
    z: -36,
    label: 'Freedom Road, out to the cape',
  },
  {
    id: 'lighthouse',
    want: 'confetti',
    x: -56,
    z: -54,
    label: 'The point below the lighthouse',
  },
  ...
  },
  {
    ...
    x: -100,
    z: 17,
    label: 'The dock on the far shore',
  },
]
