...
const SPOTS: Omit<Call, 'y' | 'crowd'>[] = [
  ...
  { id: 'north-road', want: 'water', x: 1, z: -36, label: 'Halfway up the north road' },
  { id: 'academy', want: 'confetti', x: 0, z: -59, label: 'The Academy steps' },
  { id: 'east-road', want: 'water', x: 41, z: -21, label: 'The east road, no shade on it' },
  ...
  { id: 'cape-road', want: 'water', x: -38, z: -36, label: 'The cape road' },
  ...
  { id: 'south-road', want: 'confetti', x: 0, z: 52, label: 'The south road' },
